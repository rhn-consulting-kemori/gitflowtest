...
// Test POJO class:入金可能額情報
public class AvailableDepositAmountDataEntityTest {

    // Target POJO Class
    private AvailableDepositAmountDataEntity obj;
    ...
    public void beforeEach() {
        ...
        expected_type_map.put("deposit_available_amount", "SaikenCompositeUnitEntity");
    }

    @SuppressWarnings("unchecked")
    @Test
    public void testAvailableDepositAmountDataEntity(){
        try {
            obj = (AvailableDepositAmountDataEntity.class).getDeclaredConstructor().newInstance();
            Field[] fields = AvailableDepositAmountDataEntity.class.getDeclaredFields();
            for(Field field : fields){
                ...
                Method getterMethod = AvailableDepositAmountDataEntity.class.getMethod(getter);
                Method setterMethod = AvailableDepositAmountDataEntity.class.getMethod(setter, getterMethod.getReturnType());
