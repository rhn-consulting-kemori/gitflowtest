...
// Test POJO class:入金受付チェック要求
public class DepositEntryCheckRequestTypeTest {

    // Target POJO Class
    private DepositEntryCheckRequestType obj;
    ...
    @Test
    public void testDepositEntryCheckRequestType(){
        try {
            obj = (DepositEntryCheckRequestType.class).getDeclaredConstructor().newInstance();
            Field[] fields = DepositEntryCheckRequestType.class.getDeclaredFields();
            for(Field field : fields){
                ...
                Method getterMethod = DepositEntryCheckRequestType.class.getMethod(getter);
                Method setterMethod = DepositEntryCheckRequestType.class.getMethod(setter, getterMethod.getReturnType());
